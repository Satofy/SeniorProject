      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
        ...
        {user && (
          <>
            ...
            <TeamCreateDialog open={showCreateDialog} onOpenChange={setShowCreateDialog} onCreated={handleCreated} />
          </>
        )}
      </div>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>
                    Manager: {(() => {
                      const val = String(team.managerId || "")
                      const looksLikeToken = val.includes('.') && val.length > 20
                      if (looksLikeToken) return "Hidden"
                      if (user && val && user.id === val) return "You"
                      return val || "Unknown"
                    })()}
                  </span>
                </div>
